...
VALIDITY () {
    ...
    Exp1=$(curl https://github.com/XolvaID/ip | grep $MYIP | awk '{print $4}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://github.com/XolvaID/ip | awk '{print $5}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://github.com/XolvaID/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
valid=$(curl https://github.com/XolvaID/ip | grep $MYIP | awk '{print $4}')
